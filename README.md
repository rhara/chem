...
## chembl.fetch — ChEMBL bioactivity download
...
Every call to `chembl.fetch.download_activities` prints its function name and
...
- `src/chembl/` — ChEMBL data access (`fetch.py`: `download_activities`)
